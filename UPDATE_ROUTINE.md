...
3. Confirm the website board includes current K/G values for all live/probable pitchers.
   - K/G means actual pitcher season strikeouts per game.
   - Source it from `Start_Model` as `Pitcher Season K/9 * IP/Game / 9` when the filterable board does not expose it.
