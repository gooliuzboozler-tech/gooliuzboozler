...
5. Confirm the website payload includes current overall records for Models 1, 2, 6, 4, and 5.
...
7. Publish Yesterday's Picks to the website.
...
Do not consider the website board complete until Last 5 Ks are visible for today's picks.
