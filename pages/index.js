  ...
  <div className="nav-actions">
    ...
    <a href="#pricing" className="nav-cta">Get Access</a>
      ...
      <section className="hero">
        ...
        <div>
          ...
          <p className="hero-sub">
            Sharp MLB strikeout projections powered by weighted Models 8, 2, 6, 4, and 5.
      ...
      <section id="model" style={{background:'rgba(242,237,227,0.015)', borderTop:'1px solid var(--border)', borderBottom:'1px solid var(--border)'}}>
        ...
        <p className="section-sub">
          Every board is built from Models 8, 2, 6, 4, and 5 projections, probability thresholds,
        ...
        <div className="features-grid" style={{marginTop:'3.5rem'}}>
          {[
            [
              ...
              'The highest probability across Models 8, 2, 6, 4, and 5 drives the trust grade on every play: 80%+ is Strong, 70-79% is Playable, 60-69% is Thin, and under 60% is Pass. Weekly and Monthly members see Strong and Playable plays; Season members see the full board.'
            ],
            [
              '02',
              'Five Model Reads',
        ...
        <div className="pricing-grid">
          ...
          <PriceCard
            ...
            features={[
              { yes: true, text: "Today's picks board access" },
              { yes: true, text: 'Strong + Playable plays' },
              { yes: true, text: 'Models 8, 2, 6, 4, and 5 plays' },
          ...
          <PriceCard
            ...
            features={[
              ...
              { yes: true, text: 'Models 8, 2, 6, 4, and 5 across full board' },
              { yes: true, text: 'Best parlay pick per pitcher' },
              { yes: true, text: 'K Edge + model variable breakdown' },
      ...
      <section style={{background:'rgba(242,237,227,0.015)', borderTop:'1px solid var(--border)'}}>
        ...
        <div className="faq-list">
          {[
            ...
            ['What are the five model reads?', 'Models 8, 2, 6, 4, and 5 blend recent K/G, opponent K rank, active-roster BvP, full game context, weather, wind, time of day, previous games bullpen data, and much more.'],
