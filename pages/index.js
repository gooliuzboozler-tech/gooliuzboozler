...
const BACKTEST_STAT_SETS = [
  ...
  },
  {
    key: 'model9',
    title: 'Model 9',
    subtitle: 'Selective 30%+ ROI No-side Kalshi selector for 6+ through 9+ strikeout lines',
    stats: [
      ['TBD', 'Record', ''],
      ['TBD', 'Win Rate', ''],
      ['TBD', 'ROI', ''],
...
function getModelBacktestsFromPlays(plays) {
  const source = (plays || []).find(play => play['Model 9 Backtest Record'] || play['Model 8 Backtest Record'] || play['Model 6 Backtest Record'] || play['Model 5 Backtest Record']) || {}
  const out = {}
  ;[9, 8, 2, 6, 4, 5].forEach(modelNumber => {
  ...
  <div className="nav-actions">
    ...
    <a href="#pricing" className="nav-cta">Get Access</a>
      ...
      <section className="hero">
        ...
        <div>
          ...
          <p className="hero-sub">
            Sharp MLB strikeout projections powered by weighted Models 9, 8, 2, 6, 4, and 5.
            Members get plan-based access to the picks board, with higher tiers unlocking
            all six model reads, parlay picks, K Edge, BvP context, market lines, and full-board data.
          </p>
      ...
      <section id="model" style={{background:'rgba(242,237,227,0.015)', borderTop:'1px solid var(--border)', borderBottom:'1px solid var(--border)'}}>
        ...
        <p className="section-sub">
          Every board is built from Models 9, 8, 2, 6, 4, and 5 projections, probability thresholds,
        ...
        <div className="features-grid" style={{marginTop:'3.5rem'}}>
          {[
            [
              ...
              'The highest probability across Models 9, 8, 2, 6, 4, and 5 drives the trust grade on every play: 80%+ is Strong, 70-79% is Playable, 60-69% is Thin, and under 60% is Pass. Weekly and Monthly members see Strong and Playable plays; Season members see the full board.'
            ],
            [
              '02',
              'Six Model Reads',
              'Each pitcher is checked across six model outputs. The main Best Bet is whichever model posts the highest non-pass probability, while Monthly and Season members can compare every model read.'
            ],
            [
              '03',
      ...
      <section id="pricing">
        ...
        <h2 className="section-title">Six Models.<br />Three Ways In.</h2>
        <p className="section-sub">
        ...
        <div className="pricing-grid">
          <PriceCard
            ...
            features={[
              ...
              { yes: false, text: 'All six model comparison plays' },
          ...
          <PriceCard
            ...
            features={[
              { yes: true, text: "Today's picks board access" },
              { yes: true, text: 'Strong + Playable plays' },
              { yes: true, text: 'Models 9, 8, 2, 6, 4, and 5 plays' },
          ...
          <PriceCard
            ...
            features={[
              ...
              { yes: true, text: 'Models 9, 8, 2, 6, 4, and 5 across full board' },
              { yes: true, text: 'Best parlay pick per pitcher' },
              { yes: true, text: 'K Edge + model variable breakdown' },
      ...
      <section style={{background:'rgba(242,237,227,0.015)', borderTop:'1px solid var(--border)'}}>
        ...
        <div className="faq-list">
          {[
            ['How do I access picks?', "Members log in to the Today's Picks board on the website. Weekly gets Strong and Playable best-probability plays. Monthly adds all six models, parlay picks, K Edge, BvP, and context. Season adds the full board, Thin plays, and the date archive."],
            ['What are the six model reads?', 'Models 9, 8, 2, 6, 4, and 5 blend recent K/G, opponent K rank, active-roster BvP, full game context, weather, wind, time of day, previous games bullpen data, and much more.'],
            ...
            ['What does the Season Pass include?', 'Full 2026 season access — every posted play, including Thin plays, all six website model reads, best parlay picks, K Edge, BvP context, market lines, weighted-input data, and the all-time calendar archive. One payment, no recurring charges.'],
          ].map(([q, a]) => (
