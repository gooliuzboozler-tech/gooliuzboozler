const WEBSITE_MODEL_NUMBERS = [9, 8, 2, 6, 4, 5]
...
function getModel(row, modelNumber) {
  ...
  const meetsPayoutFloor = oddsNumber >= MIN_WEBSITE_BET_PAYOUT
  ...
  function parseSection(headerIdx) {
    ...
    for (let i = headerIdx + 1; i < lines.length; i++) {
      ...
      const bestModel = eligibleModels
        .filter(model => model.number === 9)[0] || eligibleModels
      ...
      plays.push({
        ...
        'Model 9 Bet': modelByNumber[9]?.bet || '',
        ...
        'Model 9 Prob': modelByNumber[9]?.prob || '',
        ...
        'Model 9 Edge': modelByNumber[9]?.edge || '',
        ...
        'Model 9 Odds': modelByNumber[9]?.odds || '',
        ...
        'Model 9 K': modelByNumber[9]?.k || '',
        'Model 9 K Edge': modelByNumber[9]?.kEdge || '',
        ...
        'Model K': bestModel.k || modelByNumber[8]?.k || '',
        'K Edge': bestModel.kEdge || modelByNumber[8]?.kEdge || '',
        ...
        'Model 9 Backtest Record': row['Model 9 Backtest Record'] || '',
        'Model 9 Backtest Win Rate': row['Model 9 Backtest Win Rate'] || '',
        'Model 9 Backtest Plays': row['Model 9 Backtest Plays'] || '',
        'Model 9 Backtest ROI': row['Model 9 Backtest ROI'] || '',
