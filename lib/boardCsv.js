...
const MODEL8_MIN_BEST_PROBABILITY = 90
...
function isBestBetEligible(model) {
  return model.oddsNumber > BEST_BET_MIN_PAYOUT ||
    (model.number === 8 && model.probabilityNumber >= MODEL8_MIN_BEST_PROBABILITY)
}
